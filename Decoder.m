...
{
    if (!_video){
        NSLog(@"Video has not loaded yet!");
        return FALSE;
    }
    
    if (decodeAudioMode == DecodeAudioModeFFmpeg) {
        /**
...
//----------------------------------------------------------------
#pragma mark - Decoder's Video Properties
@implementation Decoder (VideoProperties)
